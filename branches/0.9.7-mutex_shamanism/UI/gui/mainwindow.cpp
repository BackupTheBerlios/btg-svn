      ...
      namespace gui
      {
              ...
              m_clientDynConfig(dc)
         {
...

            {
               ...
               /// Set continue behavior on read timeouts
               handler->setReadTimeoutContinue(true);
            }
               ...
               {
                  {
                     ...
                     if (handler->readTimeout())
                        {
                           if (questionDialog::showAndDie("Daemon timeout","Timeout communicating with daemon occured.\nTry again ?"))
                              {
                                 handler->resetReadTimeout();
                              }
                           else
                              {
                                 handler->setReadTimeoutContinue(false);
                                 handler->resetReadTimeout();
                              }
                        }

         ...
         namespace gui
            {
               ...
               class guiHandler: public btg::core::client::handlerThreadIf
                  ...
                  public:
                     ...
                     /// Set whether we should continue reading after timeout
                     void setReadTimeoutContinue(bool continue_ = true) { read_timeout_continue = continue_; }

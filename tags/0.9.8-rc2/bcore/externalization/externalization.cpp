         ...
         static const t_IdToNameElem commandMethodNames[] =
            {
               ...
               t_IdToNameElem(Command::CN_CCREATEURLABORT,     "context.createfromurlabort"),
               ...
               t_IdToNameElem(Command::CN_CCREATEFFABORT,      "context.createfromfileabort"),
               t_IdToNameElem(Command::CN_CCREATEFROMFILEPART, "context.createfromfilepart"),
               t_IdToNameElem(Command::CN_CCRFILESTATUS,       "context.filestatus"),
               t_IdToNameElem(Command::CN_CCRFILESTATUSRSP,    "context.filestatusrsp"),

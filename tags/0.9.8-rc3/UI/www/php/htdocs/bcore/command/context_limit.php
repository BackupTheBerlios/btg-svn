...
/*
 * $Id: context_limit.php,v 1.1.2.1 2006/03/27 07:17:08 jstrom Exp $
 */
...
class contextLimitCommand extends contextCommand
{
	private $limitUpld;
	private $limitDwnld;
	private $seedLimit;
	private $seedTimeout;
	public function contextLimitCommand($context_id=contextCommand::UNDEFINED_CONTEXT, $limitBytesUpld = limitBase::LIMIT_DISABLED, $limitBytesDwnld = limitBase::LIMIT_DISABLE, $seedLimit = limitBase::LIMIT_DISABLE, $seedTimeout = limitBase::LIMIT_DISABLED, $allContexts = false)
	{
		parent::__construct(Command::CN_CLIMIT, $context_id, $allContexts);

...
AC_DEFUN([BTG_LINK_CHECK],
  [
   ...
   TRY_LIBS="$btg_save_LIBS 
            $BOOST_SYSTEM_LIB $BOOST_IOSTREAMS_LIB $BOOST_FILESYSTEM_LIB $BOOST_DATE_TIME_LIB 
            $BOOST_THREAD_LIB $BOOST_PROGRAM_OPTIONS_LIB 
            $LIBTORRENT_LIBS $LIBGNUTLS_LIBS $CYBERLINK_LIBS"
   TRY_CXXFLAGS="$btg_save_CXXFLAGS $LIBTORRENT_CFLAGS $LIBGNUTLS_CFLAGS $CYBERLINK_CFLAGS"
